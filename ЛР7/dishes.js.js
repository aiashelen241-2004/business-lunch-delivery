// dishes.js - تحميل الأطباق من API

let dishes = []; // مصفوفة عامة لتخزين الأطباق

// دالة تحميل الأطباق من API
async function loadDishes() {
    try {
        // استخدام الرابط المناسب حسب مكان الاستضافة
        const apiUrl = 'https://edu.std-900.ist.mospolytech.ru/labs/api/dishes'; // لـ GitHub Pages
        // const apiUrl = 'http://lab7-api.std-900.ist.mospolytech.ru/api/dishes'; // لاستضافة الجامعة
        ...
        dishes = data; // حفظ البيانات في المصفوفة العامة
        
        console.log('Блюда успешно загружены:', dishes.length);
        
        // بعد تحميل البيانات، عرضها على الصفحة
        ...
        // إذا فشل الاتصال، استخدم البيانات المحلية كاحتياطي
...
// بيانات احتياطية في حالة فشل الاتصال (اختياري)
